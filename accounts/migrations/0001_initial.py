    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender',
                 models.CharField(blank=True, choices=[('M', '남성'), ('F', '여성')], max_length=1, verbose_name='성별')),
                ('avatar', models.ImageField(blank=True, help_text='48px * 48px 크기의 png/jpg 파일을 업로드해주세요.',
                                             upload_to='accounts/avatar/%Y/%m/%d', verbose_name='아바타이미지')),
